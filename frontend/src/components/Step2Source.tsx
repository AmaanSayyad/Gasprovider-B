...
const Step2Source: React.FC = () => {
  ...
  const estimatedFees = Math.min(0.25, Math.max(0.02, depositAmount * 0.02));
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                <ChainLogo
                  chainId={sourceChain?.viemChain.id || SOURCE_CHAINS[0].viemChain.id}
                  name={sourceChain?.name || SOURCE_CHAINS[0].name}
