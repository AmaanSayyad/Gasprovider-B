...
// FTSO Price Snapshot
export interface FTSOPriceSnapshot {
  feedId: string;
  symbol: string;
  value: string;
  decimals: number;
...
export interface DepositIntent {
  ...
  fdcProofHash?: string;
  isFAsset?: boolean;
  underlyingAsset?: string; // For FAssets: 'BTC', 'DOGE', 'XRP'
  ftsoFeedIds?: string[]; // Feed IDs used for pricing
  ftsoPrices?: FTSOPriceSnapshot[];
